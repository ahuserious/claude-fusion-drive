...
| SUB-02 | claude-fable-5 max drives Grok fusion | `grok-fusion-drive` preset | `test_reasoning_presets.py` |
...
| PKG-01 | Installable Claude Code plugin bundle | Manifest, MCP config, six skills | `test_plugin_surface.py` |
