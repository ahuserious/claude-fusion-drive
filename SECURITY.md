...
The public [Codex fusion artifact](https://github.com/ahuserious/codex-fusion-artifact/tree/limited-cost-2026-07-20), inherited from the validated Codex edition, is curated evidence, not a safe destination for new private run data.
