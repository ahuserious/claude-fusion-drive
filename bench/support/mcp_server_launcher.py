...
SECRET_PATH = Path("/run/secrets/claude-fusion-drive-xai")
MCP_SERVER_PATH = "/opt/claude-fusion-drive/mcp_server.py"
DATA_DIRECTORY = "/logs/agent/claude-fusion-drive"
...
def main() -> None:
    ...
    os.environ["RELENTLESS_INCEPTION_CONFIG"] = (
        "/opt/claude-fusion-drive/config/default.json"
    )
